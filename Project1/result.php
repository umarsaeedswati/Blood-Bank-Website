...
?>
	...
	<button style="background-color: rgb(65, 190, 65);font-size: 25px; font-family: 'Times New Roman', Times, serif;"><a href="delete.php?id=<?php echo $data['id']; ?>">Delete</button>
</center>
</body>
</html>
